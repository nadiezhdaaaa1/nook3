...
export const HERO_CITIES: HeroCity[] = [
  {
    ...
    stats: [
      ...
      { value: "30–50", label: "Avg days to lease" },
      { value: "300–600", label: "New listings/day" },
    ],
    cardImg: nycCard.url,
    bgImg: nycBg.url,
  },
  {
    ...
    stats: [
      ...
      { value: "60–90", label: "Avg days to lease" },
      { value: "330–500", label: "New listings/day" },
    ],
    cardImg: laCard.url,
    bgImg: laBg.url,
  },
  {
    ...
    stats: [
      ...
      { value: "30–40", label: "Avg days to lease" },
      { value: "375–650", label: "New listings/day" },
    ],
    cardImg: sfCard.url,
    bgImg: sfBg.url,
  },
  {
    ...
    stats: [
      { value: "19,000", label: "Active listings" },
      { value: "30–45", label: "Avg days to lease" },
      { value: "420–630", label: "New listings/day" },
    ],
    cardImg: chiCard.url,
    bgImg: chiBg.url,
  },
