...
export const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "You can cancel any time — your data is preserved for 30 days in case you come back, so your filters and history are still there if your lease falls through or you start looking again.",
  },
  {
