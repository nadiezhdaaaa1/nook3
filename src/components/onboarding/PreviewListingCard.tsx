...
function WrenGlow() {
  return (
    <motion.div
      aria-hidden
      className="pointer-events-none absolute -inset-[3px] rounded-[13px] blur-lg opacity-0 transition-opacity duration-300 group-hover/glow:opacity-50 motion-reduce:hidden"
      animate={{
        background: [
