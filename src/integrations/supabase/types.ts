  ...
  public: {
    Tables: {
      ...
      wren_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "wren_conversations_search_id_fkey"
            columns: ["search_id"]
            isOneToOne: false
            referencedRelation: "searches"
            referencedColumns: ["id"]
      ...
      wren_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "wren_messages_conversation_id_fkey"
            columns: ["conversation_id"]
            isOneToOne: false
            referencedRelation: "wren_conversations"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      admin_set_plan: {
        Args: {
          ...
          _subscription_status?: Database["public"]["Enums"]["app_subscription_status"]
          _user_id: string
        }
        Returns: {
          billing_cycle: Database["public"]["Enums"]["billing_cycle"]
      ...
      dev_set_account_state: {
        Args: {
          _billing_cycle?: Database["public"]["Enums"]["billing_cycle"]
          _clear_past_due?: boolean
          _has_ever_subscribed?: boolean
          _no_credentials?: boolean
          _onboarded?: boolean
          _past_due_since?: string
          _plan?: Database["public"]["Enums"]["app_plan"]
          _status?: Database["public"]["Enums"]["app_subscription_status"]
          _user_id: string
        }
        Returns: {
          billing_cycle: Database["public"]["Enums"]["billing_cycle"]
